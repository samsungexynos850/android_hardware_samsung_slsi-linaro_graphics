...
#define TSMUX_IOCTL_SET_INFO _IOW('T', 0x1, struct tsmux_psi_info)
#define TSMUX_IOCTL_M2M_MAP_BUF _IOWR('A', 0x10, struct tsmux_m2m_cmd_queue)
#define TSMUX_IOCTL_M2M_UNMAP_BUF _IO('A', 0x11)
#define TSMUX_IOCTL_M2M_RUN _IOWR('A', 0x12, struct tsmux_m2m_cmd_queue)
#define TSMUX_IOCTL_OTF_MAP_BUF _IOR('A', 0x13, struct tsmux_otf_cmd_queue)
#define TSMUX_IOCTL_OTF_UNMAP_BUF _IO('A', 0x14)
#define TSMUX_IOCTL_OTF_DQ_BUF _IOR('A', 0x15, struct tsmux_otf_cmd_queue)
#define TSMUX_IOCTL_OTF_Q_BUF _IOW('A', 0x16, int32_t)
#define TSMUX_IOCTL_OTF_SET_CONFIG _IOW('A', 0x17, struct tsmux_otf_config)
#define TSMUX_IOCTL_SET_RTP_TS_INFO _IOW('A', 0x20, struct tsmux_rtp_ts_info)
#define TSMUX_IOCTL_GET_RTP_TS_INFO _IOR('A', 0x21, struct tsmux_rtp_ts_info)
#endif
